...
# Streamlit UI
st.title("Disease Surveillance Web App")

st.write("This app scans your message and detects possible illness symptoms.")

user_input = st.text_area("Type your post (like a tweet):")

if st.button("Scan for symptoms"):
    g = geocoder.ip('me')
    location = g.city or "Unknown"
    result = detect_symptoms(user_input, location)
